...
%}
        ...
        function [Cx, Cy, Cz] = centerofmass(obj, lx, ly, lz, rho)
...
%}
        function [inertia] = linkinertia(obj, i, lx, ly, lz, rho)
            ...
            [Cx, ~, ~]= obj.centerofmass(lx(i),ly(i),lz(i),rho);
